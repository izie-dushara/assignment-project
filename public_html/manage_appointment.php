...
<html lang="en">
	...
	<body>
		...
		$appointmentQuery = "SELECT appointment_id, service_name, senior_lastname, appointed_date, time_slot, notes, senior_addressline1, senior_addressline2, senior_postcode, state_name 
			FROM appointment
				...
				INNER JOIN state on senior.state_id = state.state_id
					WHERE service.contractor_id = $id and appointment_status = 'APPROVED';";
